        ...
        try:  
            ...
            for message in messages:  
                ...
                if application_code:
                    ...
                    # Both VAPT and SAST Configurations
                    reports = [  
                        {
                        ...
                        },
                        {
                            ...
                            "sheet_name": "Tracker", 
                            "header_row": 0,  # Assuming header is on the first row
                            "app_column": 'Application Code', 
                            "report_name": "SAST",
                            "columns_to_extract": [
                    ...
                    if generated_attachments:
                        self.send_email_with_attachments( 
                            ...
                            body=f"Hello,\n\nPlease find the requested security reports (VAPT/SAST) for {application_code} attached.\n\nRegards,\nInfosec Team",
